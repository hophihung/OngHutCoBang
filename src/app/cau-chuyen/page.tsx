      ...
      <main className="flex flex-col w-full">
        ...
        <section className="relative w-full h-[85vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src={HERO_IMAGE}
              alt="Wide panoramic shot of lush green grass fields in the Mekong Delta under a bright sky"
              fill
          ...
          <div className="relative z-10 text-center max-w-4xl px-4 flex flex-col items-center gap-6">
            ...
            <div className="mt-4">
              <Link
                href="/cua-hang"
                className="inline-block bg-[#2f7f34] hover:bg-[#1e5622] text-black px-8 py-3 rounded-lg text-base font-bold transition-transform hover:scale-105"
              >
        ...
        {/* Mission Section */}
        <section className="py-24 bg-[#f6f8f6] dark:bg-[#102210]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative group">
                <div className="absolute -inset-2 bg-[#2f7f34]/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition duration-500" />
                <div className="relative h-[500px] w-full rounded-xl overflow-hidden shadow-xl">
                  <Image
                    src={MISSION_IMAGE}
                    alt="Close up portrait of a smiling Vietnamese farmer holding bundles of fresh green grass in a field"
                    fill
                    className="object-cover"
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    <p className="text-sm font-medium uppercase tracking-wider mb-1 text-[#2f7f34]">
                      Local Impact
                    </p>
              ...
              <div className="flex flex-col gap-8">
                <div>
                  <h2 className="text-4xl font-bold text-[#111811] dark:text-white mb-6 leading-tight">
                    Our Mission:{" "}
                    <span className="text-[#2f7f34]">Empowerment</span> &
                    Sustainability
                  </h2>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-4 rounded-lg bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-sm">
                    <span className="material-symbols-outlined text-3xl text-[#2f7f34] mb-2">
                      recycling
                    </span>
                ...
                <Link
                  href="/blog"
                  className="self-start flex items-center gap-2 text-[#111811] dark:text-white font-bold border-b-2 border-[#2f7f34] pb-1 hover:text-[#2f7f34] transition-colors"
                >
        ...
        <section className="py-24 bg-white dark:bg-[#0a160a]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-[#2f7f34] font-bold tracking-wider uppercase text-sm">
                Our Process
              </span>
            ...
            <div className="hidden lg:grid grid-cols-4 gap-4 relative">
              <div className="absolute top-8 left-[12%] right-[12%] h-[2px] border-t-2 border-dashed border-gray-200 dark:border-gray-700 -z-0" />
              {[
                {
                  icon: "agriculture",
                  title: "Harvesting",
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-[#f6f8f6] dark:bg-white/10 border-2 border-[#2f7f34] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform bg-white dark:bg-[#102210]">
                    <span className="material-symbols-outlined text-[#2f7f34] text-3xl">
                      {step.icon}
                    </span>
                  </div>
              ...
              {[
                ...
                <div key={step.title} className="flex gap-4">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-[#2f7f34] flex items-center justify-center text-black font-bold">
                      {i + 1}
                    </div>
                    {i < 3 && (
                      <div className="w-0.5 flex-1 min-h-[40px] bg-gray-200 dark:bg-gray-700 my-2" />
                    )}
                  </div>
                  <div className="pb-8">
                    <h3 className="font-bold text-lg dark:text-white">
        ...
        <section className="py-24 bg-[#e8efe8] dark:bg-[#102210]/50 relative overflow-hidden">
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-[#2f7f34]/10 rounded-full blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-[#2f7f34]/10 rounded-full blur-3xl" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 mt-4">
                  {[
                    ...
                    <div
                      key={item.title}
                      className="flex gap-4 items-start p-4 bg-white dark:bg-[#102210] rounded-xl shadow-sm border border-transparent hover:border-[#2f7f34]/30 transition-colors"
                    >
                      <div className="p-3 bg-[#2f7f34]/10 rounded-lg text-[#2f7f34] shrink-0">
              ...
              <div className="order-1 lg:order-2 flex justify-center items-center">
                <div className="relative w-full max-w-md aspect-square bg-white dark:bg-white/5 rounded-full shadow-2xl p-8 flex items-center justify-center border border-white/50 dark:border-white/10">
                  <div className="relative z-10 w-48 h-48 rounded-full overflow-hidden border-4 border-[#2f7f34]/20 shrink-0">
                    <Image
                      src={CIRCULAR_IMAGE}
                      alt="Close up detailed shot of green sedge grass stems growing vertically"
                      fill
                      className="object-cover"
                      sizes="192px"
                    />
                  </div>
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-lg border border-[#2f7f34]/20">
                    <span className="text-sm font-bold text-[#2f7f34]">
                      Handicrafts
                    </span>
                  </div>
                  <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg shadow-lg border border-[#2f7f34]/20">
                    <span className="text-sm font-bold text-[#2f7f34]">
                      Straws
                    </span>
                  </div>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-[#102210] dark:bg-[#0a160a] text-white relative overflow-hidden">
          <div
