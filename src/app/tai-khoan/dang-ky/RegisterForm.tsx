...
export default function RegisterForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (password !== confirmPassword) {
      setError("Mật khẩu và xác nhận mật khẩu không trùng nhau.");
      return;
    }
    ...
    setSuccessMessage("Vui lòng kiểm tra email để xác nhận tài khoản.");
  }
    ...
    <div className="flex min-h-full flex-col items-center justify-center px-6 py-12 lg:px-20 xl:px-32">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex w-full items-center justify-center rounded-lg bg-[#2f7f34] hover:bg-[#1e5622] disabled:opacity-60 disabled:pointer-events-none px-5 py-3.5 text-white shadow-sm transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2f7f34] mt-2"
        >
          <span className="text-sm font-bold tracking-wide uppercase">
