    ...
    <div className="mt-4 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="flex flex-col gap-6">
        <div className="relative w-full aspect-square overflow-hidden rounded-[2rem] bg-[#f0f4f0] dark:bg-[#1a2e1d] group">
          ...
          />
          {product.badge && (
            <div className="absolute top-4 left-4 rounded-full bg-white/90 dark:bg-white/90 px-3 py-1 text-xs font-bold text-[#1c5f21] backdrop-blur-sm">
              {product.badge}
            </div>
          )}
        </div>
            ...
            <button
              ...
              className={`relative h-24 w-24 shrink-0 overflow-hidden rounded-2xl border-2 p-0.5 transition-colors ${
                i === selectedImageIndex
                  ? "border-[#1c5f21]"
                  : "border-transparent hover:border-[#1c5f21]/50"
              }`}
            >
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex grow gap-3">
            <button
              type="button"
              className="flex h-12 grow items-center justify-center gap-2 rounded-full bg-[#1c5f21] px-6 text-sm font-bold text-white shadow-lg shadow-[#1c5f21]/25 hover:bg-[#164d1b] transition-colors"
            >
              <span className="material-symbols-outlined text-[20px]">
                shopping_bag
              </span>
